...
abstract class DisplayDate with _$DisplayDate {
  ...
  factory DisplayDate.fromJson(Map<String, dynamic> json) =>
...
abstract class DaytimeForecast with _$DaytimeForecast {
  ...
  factory DaytimeForecast.fromJson(Map<String, dynamic> json) =>
...
abstract class NighttimeForecast with _$NighttimeForecast {
  ...
  factory NighttimeForecast.fromJson(Map<String, dynamic> json) =>
...
abstract class FeelsLikeMaxTemperature with _$FeelsLikeMaxTemperature {
  ...
  factory FeelsLikeMaxTemperature.fromJson(Map<String, dynamic> json) =>
...
abstract class FeelsLikeMinTemperature with _$FeelsLikeMinTemperature {
  ...
  factory FeelsLikeMinTemperature.fromJson(Map<String, dynamic> json) =>
...
abstract class SunEvents with _$SunEvents {
  ...
  factory SunEvents.fromJson(Map<String, dynamic> json) =>
...
abstract class MoonEvents with _$MoonEvents {
  ...
  factory MoonEvents.fromJson(Map<String, dynamic> json) =>
...
abstract class MaxHeatIndex with _$MaxHeatIndex {
  ...
  factory MaxHeatIndex.fromJson(Map<String, dynamic> json) =>
...
abstract class SeaLevelPressure with _$SeaLevelPressure {
  ...
  factory SeaLevelPressure.fromJson(Map<String, dynamic> json) =>
